  ...
  return (
    ...
    >
      ...
      <div className="container px-4 mx-auto relative z-10">
        <h2
          ref={headingRef}
          className="text-4xl sm:text-6xl md:text-7xl font-extrabold mb-12 sm:mb-20 text-center bg-gradient-to-r from-blue-400 via-cyan-400 to-teal-400 bg-clip-text text-transparent animate-gradient-text"
        >
          Skills & Expertise
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 sm:gap-12 md:gap-16">
